...
Vivere는 MIT 라이선스의 오픈소스 프로젝트이며 저장소는 [github.com/jb0xyz/vivere](https://github.com/jb0xyz/vivere)입니다. npm 패키지 이름은 `@jb0xyz/vivere`입니다. 현재 패키지 버전은 `0.3.0`입니다. 아직 초기 단계지만, 파일 기반 명령과 컴포넌트 작성 흐름은 동작합니다.
